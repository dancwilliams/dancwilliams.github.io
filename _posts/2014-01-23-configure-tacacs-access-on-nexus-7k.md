...
Two new Nexus 7Ks have been installed at one of my client’s data centers. Management connectivity was brought up to the data center core and verified. I was given console access and told to configure TACACS+[[1]](1 "see footnote") authentication and authorization on the F2 VDC[[2]](2 "see footnote").
<!--more-->
## The Solution:
